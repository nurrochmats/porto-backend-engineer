...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            'rounded-xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm text-zinc-100 shadow-sm transition-all duration-300 hover:border-zinc-700',
            className
        )}
        {...props}
    />
